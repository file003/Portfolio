...
{
 private:
  std::list<int> page_list;  //Doubly linked list to track page access order
  std::unordered_map<int, std::list<int>::iterator> page_map;  //Hash map to store page numbers and corresponding list iterators
