...
public:
     ...
     * @return True if the page is valid (present in physical memory), false otherwise.
     */
    bool isPageValid(int i);
    
    /**
     * @brief Mark a page as valid (present in physical memory).
     * @param i The index of the page.
     */
    void markPageValid(int i);

    /**
     * @brief Mark a page as invalid (not present in physical memory).
     * @param i The index of the page.
     */
    void markPageInvalid(int i);
};